...
# 한글 폰트 설정 (깃허브에 업로드된 폰트 파일 경로)
# 깃허브 최상단 디렉토리에 NanumGothic.ttf 파일이 있다고 가정합니다.
...
if analyze_btn and url:
    ...
    if not video_id:
        ...
        with st.spinner("댓글을 수집하고 분석하는 중입니다... (댓글 수에 따라 시간이 걸릴 수 있습니다)"):
            # 데이터 수집
